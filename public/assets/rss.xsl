...
<!--
@credit: https://github.com/genmon/aboutfeeds/blob/main/tools/pretty-feed-v3.xsl
-->
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
      <head>
        ...
        <link rel="stylesheet" href="/assets/rss.css" media="screen" />
        ...
        <div class="feed-container-md px-3 py-3 text-content">
          ...
          <xsl:for-each select="/rss/channel/item">
            <div class="pb-5">
              ...
              <small class="color-text-gray text-pubdate">
